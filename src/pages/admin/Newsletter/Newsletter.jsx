...
export function Newsletter() {
  ...
  return (
    <div className="newsletter-page">
      <div className="newsletter-page__toolbar">
        <div className="newsletter-page__filters">
          <button
        ...
        <div className="newsletter-page__actions">
          <div className="newsletter-page__search-wrapper">
            <svg
              className="newsletter-page__search-icon"
              width="16"
              height="16"
              viewBox="0 0 24 24"
              fill="none"
            ...
            <input
              ...
              className="newsletter-page__search"
            />
          </div>
        </div>
      </div>

      {loading && <p className="newsletter-page__state">Cargando suscriptores...</p>}
      {error && (
        <p className="newsletter-page__state newsletter-page__state--error">
          {error}
        </p>
      )}
      {!loading && !error && subscribers.length === 0 && (
        <p className="newsletter-page__state">No se encontraron suscriptores.</p>
      )}

      {!loading && !error && (
        <p className="newsletter-page__total">
            ...
            <tbody>
              {subscribers.map((sub, index) => (
                <tr key={sub._id}>
                  ...
                  <td className="newsletter-table__email">{sub.email}</td>
                  <td>
                    <span
                  ...
                  {hasRole("editor") && (
                    <td>
                      <div className="newsletter-table__actions">
                        <button
      ...
      {!loading && totalPages > 1 && (
        <div className="newsletter-pagination">
          <button
            ...
            className="newsletter-pagination__nav"
          >
            ← Anterior
          </button>

          <div className="newsletter-pagination__pages">
