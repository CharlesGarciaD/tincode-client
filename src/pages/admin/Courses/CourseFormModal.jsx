...
export function CourseFormModal({ course, onClose, onSaved }) {
  ...
  const validate = () => {
    ...
    if (formValues.price === "" || Number(formValues.price) < 0) newErrors.price = "Precio inválido";
      ...
      <div className="course-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="course-modal__form">
          <div className="course-modal__image-section">
            <label htmlFor="course-image-input" className="course-modal__image-preview">
              {imagePreview ? <img src={imagePreview} alt="Curso" /> : <span>🎓</span>}
              <div className="course-modal__image-overlay">Cambiar miniatura</div>
            </label>
            <input
          ...
          <div className="course-modal__row">
            <div className="course-modal__field">
          ...
          {!isEdit && (
            <div className="course-modal__field course-modal__field--checkbox">
              <label>
                <input
                  type="checkbox"
                  name="active"
          ...
          {serverError && <p className="course-modal__error">{serverError}</p>}
