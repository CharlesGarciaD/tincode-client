...
// igual que hicimos con Newsletter/Blog — la estructura ya está lista
// para recibir { label, path } desde el backend.
const DEFAULT_LINKS = {
  producto: [
    { label: "Inicio", path: "/" },
...
export function FooterMenu() {
  return (
    <div className="tc-footer-menu">
      <div className="tc-footer-menu__col">
        <h4 className="tc-footer-menu__heading">Producto</h4>
        <ul>
      ...
      <div className="tc-footer-menu__col">
        <h4 className="tc-footer-menu__heading">Legal</h4>
        <ul>
